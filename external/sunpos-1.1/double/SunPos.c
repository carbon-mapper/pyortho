...
void sunpos(cTime udtTime, double lat, double lon, cSunCoordinates *udtSunCoordinates)
{
...
cSunCoordinates sunposf(cTime udtTime, double lat, double lon)
{
	cSunCoordinates ret;
	sunpos(udtTime, lat, lon, &ret);
	return ret;
}
